              ...
              return GestureDetector(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      radius: 35,
                      backgroundImage: _contacts[index]['user']['pictureUrl'] !=
                              null
                          ? NetworkImage(_contacts[index]['user']['pictureUrl'])
                          : null,
                      child: _contacts[index]['user']['pictureUrl'] == null
                          ? Text(
                        ...
                        children: <Widget>[
                          Text(
                            DateFormat('dd/MM/yyyy - hh:mm').format(
                                DateTime.parse(
                                    _contacts[index]['messages'][0]['time'])),
                            style: TextStyle(
                              fontSize: 14,
