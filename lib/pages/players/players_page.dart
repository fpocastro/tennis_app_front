...
class _PlayersPageState extends State<PlayersPage> {
  ...
  void _loadPlayers() async {
    ...
    final String requestUrl = globals.apiMainUrl +
        '/api/users?latLng=-51.1896887,-30.01&maxDistance=' + (_user.playersSearchDistance * 1000).toString();
                  ...
                  ? GestureDetector(
                      ...
                      child: Row(
                        children: <Widget>[
                          CircleAvatar(
                            radius: 35,
                            backgroundImage: _contacts[index].pictureUrl != null
                                ? NetworkImage(_contacts[index].pictureUrl)
                                : null,
                            child: _contacts[index].pictureUrl == null
                                ? Text(
                                    _contacts[index].name.split(' ').first[0] +
                                        _contacts[index]
                                            .name
                                            .split(' ')
                                            .last[0],
